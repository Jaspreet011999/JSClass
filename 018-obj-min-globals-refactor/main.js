...
const mpgObj ={
    ...
    calculateAvgValue: function (){
        ...
        const avgTripCost = Math.round(sumMPG/this.myMPG.length)
        this.updateDOM(`Averahe MPG is${avgMPG} , #output-avg`)
        this.updateDOM(`Average Trip Cost is ${avg}, #output-avg`)

    },
    validateFom: function (e){
        const errMsg =[]
